					...
					<article class="col-lg-3 col-md-4 col-sm-6 col-12 tm-gallery-item">
						<figure>
							...
							<figcaption>
								...
								<p class="tm-gallery-price">$45 / $55<br>
					...
					<article class="col-lg-3 col-md-4 col-sm-6 col-12 tm-gallery-item">
						<figure>
							...
							<figcaption>
								...
								<p class="tm-gallery-description">Nam in suscipit nisi, sit amet consectetur metus. Ut sit amet tellus accumsan</p>
								<p class="tm-gallery-price">$65 / $70<br>
								 <a href=""><button type="button" class="btn btn-lg btn-primary">pagar com Cripto</button></a>
								 <a href="https://www.coinpayments.net/index.php?cmd=_cart"><img src="https://www.coinpayments.net/images/pub/checkout-blue.png" alt="Pagar com Cripto" border=0></a>
							</figcaption>
						</figure>
					</article>
					<article class="col-lg-3 col-md-4 col-sm-6 col-12 tm-gallery-item">
